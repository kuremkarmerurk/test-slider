...
import Slide_1 from '../img/slide-1-wood.png'
import Slide_2 from '../img/slide-2-gray.png'
import Slide_3 from '../img/slide-3-red.png'
import Slide_4 from '../img/slide-4-white.png'
...
class Slider extends React.Component {
		...
		renderSlides() {
			const translation = 100/this.state.slides.length + "%"

			return this.state.slides.map((item,index) => (
					<div 
							className='each-slide'
							key = {index}
							style = {{backgroundImage: item.eachSlide, width: translation}}>
					</div>		
				))
		}
		renderDots(){
